...
import com.example.opengl.objects.Mallet2;
...
import com.example.opengl.utils.TextureHelper;
...
public class AirHockey6Renderer implements Renderer {
    ...
    private ColorShader2Program colorProgram;
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        colorProgram = new ColorShader2Program(context);
