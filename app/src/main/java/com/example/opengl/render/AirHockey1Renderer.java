...
public class AirHockey1Renderer implements Renderer {
    ...
    /** use x,y two byte ,vec4 default(0,0,0,1) */
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        String vertexShaderSource = TextResourceReader
                .readTextFileFromResource(context, R.raw.air01_vertex_shader);
        String fragmentShaderSource = TextResourceReader
                .readTextFileFromResource(context, R.raw.air01_fragment_shader);
